        ...
        ScrollView(/*@START_MENU_TOKEN@*/.vertical/*@END_MENU_TOKEN@*/, showsIndicators: false) {
          ...
          VStack(spacing:30) {
            ...
            VStack(spacing:30) {
              ...
              CustomButton(padding: 30, backgroundColor: Color(#colorLiteral(red: 0.9607843137, green: 0.3529411765, blue: 0, alpha: 1)), title: "Sign In") {
                withAnimation {
                  homeView.toggle()
                }
              }
